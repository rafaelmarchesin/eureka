...
/**
 * === ANOTAÇÕES ===
 * Nada na nossa aplicação será deletado, ou seja, a parte do CRUD referente ao
 * "delete" fará apenas o "update". Será feita atualização para que ele não seja
 * mais exibido, no entando, ele estará registrado no banco de dados com objetivos
 * históricos.
*/